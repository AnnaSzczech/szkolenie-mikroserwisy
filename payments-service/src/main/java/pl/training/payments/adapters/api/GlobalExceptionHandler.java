...
@RestControllerAdvice(basePackages = "pl.training.payments.adapters.api")
...
class GlobalExceptionHandler {
    ...
    ResponseEntity<ExceptionDto> onPaymentNotFound(PaymentNotFoundException exception, Locale locale) {
